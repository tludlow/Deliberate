...
export default function TeamCalendar(props: { teamName: string }) {
    let now = dayjs()
    ...
    useEffect(() => {
        ...
        daysToLoad.forEach((day: any) => {
            api.get(`/team/${props.teamName}/calendar/day/${day}`)
                .then((response: any) => {
    ...
    const loadFuture = () => {
        ...
        api.get(`/team/${props.teamName}/calendar/${largestLoadedDay.day}/future`)
            .then((response) => {
    ...
    const loadPast = () => {
        ...
        api.get(`/team/${props.teamName}/calendar/${lowestDayLoaded.day}/past`)
            .then((response) => {
