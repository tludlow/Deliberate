...
export default function CreateTeam() {
    ...
    return (
        <Layout title="Create A Team" contained>
            <section className="my-6 bg-white p-4 border border-gray-200 rounded shadow">
                    ...
                    {({ errors, status, touched }) => (
                        <Form className="mt-2 flex flex-col">
                            ...
                            <div className="flex flex-col">
                                <label className="mt-6 font-bold text-xl" htmlFor="name">
                                    Team name
                                </label>
                                    ...
                                    >
                                        <span>
                                            <svg
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
                                                className="user-group w-6 h-6 mr-2"
                                            >
                            ...
                            <input
                                className="mt-6 w-1/6 h-12 bg-brand text-white font-medium rounded cursor-pointer hover:bg-blue-500"
                                type="submit"
                                value="Create Team"
                            />
                        </Form>
