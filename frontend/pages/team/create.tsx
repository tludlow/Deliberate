...
//             <section className="p-4 my-6 bg-white border border-gray-200 rounded shadow">
...
//                                 <label className="mt-6 text-xl font-bold" htmlFor="name">
//                                     Team name
//                                 </label>
...
//                             {/* Team type */}
//                             <p className="mt-6 text-xl font-bold">Team type</p>
...
//                             </div>
//                             <input
//                                 className="w-1/6 h-12 mt-6 font-medium text-white rounded cursor-pointer bg-brand hover:bg-blue-500"
//                                 type="submit"
//                                 value="Create Team"
//                             />
//                         </Form>
...
export default function CreateTeam() {
    return (
        <Layout title="Create team" contained>
            <section className="grid grid-cols-2 mt-8 rounded shadow">
                <div className="flex justify-center p-4 bg-white">
                    <div>
                        <h2 className="text-2xl font-bold text-brand">Create Team</h2>
                    </div>
                </div>
